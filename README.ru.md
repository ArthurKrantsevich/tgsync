...
<sub>Иллюстрации с вымышленным проектом; подписи кнопок — настоящие. Задачи в примерах написаны по-английски: агент отвечает на языке сообщения.</sub>
...
Пока нет — интерфейс бота только на русском. Документация полностью двуязычная.
